...
?>
                ...
                <div class="card">
                  ...
                  <div class="row">
                      <div class="col">
                        <h4 class="card-title">Active Student Advance Payments</h4>
                      </div>
...
$selectquery = " select * from payments where status='Active' AND ptype='1st Advance' OR ptype='2nd Advance' AND paystatus='Paid' ORDER BY recorddate DESC  ";
$query= mysqli_query($conn,$selectquery);
$num= mysqli_num_rows($query);
$counter = 0;
